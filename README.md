...
- Put your Algorithm into python folder
- The Algorithm should be initialized as a function (Analyze the exisiting algorithms to get the idea)
- keep your algorithm clean and simple
